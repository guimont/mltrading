...
public class CacheRawMaterial {
    ...
    static {
        ...
        aMap.put("DTOE", new StockRawMat("ETOD", "Euro_Dollar", "http://fr.investing.com/currencies/eur-usd-historical-data", RAW_DTOE_POS));
        aMap.put("ETOL", new StockRawMat("ETOL", "Euro_Livre", "http://fr.investing.com/currencies/eur-gbp-historical-data", RAW_ETOL_POS));
        aMap.put("LTOD", new StockRawMat("LTOD", "Livre_Dollar", "http://fr.investing.com/currencies/gbp-usd-historical-data", RAW_LTOD_POS));
        aMap.put("ETOY", new StockRawMat("ETOY", "Euro_Yen", "http://fr.investing.com/currencies/eur-jpy-historical-data", RAW_ETOY_POS));
        aMap.put("DTOC", new StockRawMat("DTOC", "Dollar_yuan", "http://fr.investing.com/currencies/usd-cny-historical-data", RAW_DTOC_POS));

        //not enough history
        //aMap.put("DJCOM", new StockRawMat("DJCOM", "DJ_Commodity", "http://fr.investing.com/indices/dj-commodity-historical-data", RAW_DJCOM_POS));
        //aMap.put("DJCOMEN", new StockRawMat("DJCOMEN", "DJ_Commodity_ennergy", "http://fr.investing.com/indices/dj-commodity-energy-historical-data", RAW_DJCOMEN_POS));
        ...
        aMap.put("PLAT", new StockRawMat("PLAT", "Platinium", "http://fr.investing.com/commodities/platinum-historical-data", RAW_PLAT_POS));
        aMap.put("PALA", new StockRawMat("PALA", "Paladium", "http://fr.investing.com/commodities/palladium-historical-data", RAW_PALA_POS));


        aMap.put("WHEAT", new StockRawMat("WHEAT", "Ble", "http://fr.investing.com/commodities/us-wheat-historical-data", RAW_WHEAT_POS));
        aMap.put("CORN", new StockRawMat("CORN", "Mais", "http://fr.investing.com/commodities/us-corn-historical-data",RAW_CORN_POS));
        ...
        aMap.put("UKRI1M", new StockRawMat("UKRI1M", "UK_1_mois", "http://fr.investing.com/rates-bonds/uk-1-month-bond-yield-historical-data", RAW_UKRI1M_POS));
        aMap.put("UKRI1Y", new StockRawMat("UKRI1Y", "UK_1_an", "http://fr.investing.com/rates-bonds/uk-1-year-bond-yield-historical-data", RAW_UKRI1Y_POS));
        aMap.put("UKRI10Y", new StockRawMat("UKRI10Y", "UK_10_ans", "http://fr.investing.com/rates-bonds/uk-10-year-bond-yield-historical-data", RAW_UKRI10Y_POS));

        aMap.put("GYRI1M", new StockRawMat("GYRI1M", "Germany_1_mois", "http://fr.investing.com/rates-bonds/germany-1-month-bond-yield-historical-data", RAW_GYRI1M_POS));
        aMap.put("GYRI1Y", new StockRawMat("GYRI1Y", "Germany_1_an", "http://fr.investing.com/rates-bonds/germany-1-year-bond-yield-historical-data", RAW_GYRI1Y_POS));
        aMap.put("GYRI10Y", new StockRawMat("GYRI10Y", "Germany_10_ans", "http://fr.investing.com/rates-bonds/germany-10-year-bond-yield-historical-data", RAW_GYRI10Y_POS));

        aMap.put("SPRI1M", new StockRawMat("SPRI1M", "Spain_3_mois", "http://fr.investing.com/rates-bonds/spain-3-month-bond-yield-historical-data", RAW_SPRI1M_POS));
        aMap.put("SPRI1Y", new StockRawMat("SPRI1Y", "Spain_1_an", "http://fr.investing.com/rates-bonds/spain-1-year-bond-yield-historical-data", RAW_SPRI1Y_POS));
        aMap.put("SPRI10Y", new StockRawMat("SPRI10Y", "Spain_10_ans", "http://fr.investing.com/rates-bonds/spain-10-year-bond-yield-historical-data", RAW_SPRI10Y_POS));

        aMap.put("ITRI1M", new StockRawMat("ITRI1M", "Italy_3_mois", "http://fr.investing.com/rates-bonds/italy-3-month-bond-yield-historical-data", RAW_ITRI1M_POS));
        aMap.put("ITRI1Y", new StockRawMat("ITRI1Y", "Italy_1_an", "http://fr.investing.com/rates-bonds/italy-1-year-bond-yield-historical-data", RAW_ITRI1Y_POS));
        aMap.put("ITRI10Y", new StockRawMat("ITRI10Y", "Italy_10_ans", "http://fr.investing.com/rates-bonds/italy-10-year-bond-yield-historical-data", RAW_ITRI10Y_POS));

        aMap.put("CHRI1Y", new StockRawMat("CHRI1Y", "China_1_an", "http://fr.investing.com/rates-bonds/china-1-year-bond-yield-historical-data", RAW_CHRI1Y_POS));
        aMap.put("CHRI10Y", new StockRawMat("CHRI10Y", "China_10_ans", "http://fr.investing.com/rates-bonds/china-10-year-bond-yield-historical-data", RAW_CHRI10Y_POS));
