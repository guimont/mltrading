 ...
 */
public class InfluxDaoConnectorPerf {

    private InfluxDao dao;
    static String dbName = "perf";

    private InfluxDaoConnectorPerf() {
    ...
    private static class InfluxDaoConnectorHolder {
        ...
        private final static InfluxDaoConnectorPerf instance = new InfluxDaoConnectorPerf();
    }

    public static InfluxDaoConnectorPerf getInstance() {
