 ...
 */
public class InfluxDaoConnectorDocument {

    private InfluxDao dao;
    static String dbName = "document";

    private InfluxDaoConnectorDocument() {
    ...
    private static class InfluxDaoConnectorHolder {
        ...
        private final static InfluxDaoConnectorDocument instance = new InfluxDaoConnectorDocument();
    }

    public static InfluxDaoConnectorDocument getInstance() {
