 ...
 */
public class InfluxDaoConnectorModelBackup {

    private InfluxDao dao;
    static String dbName = "modelNote";

    private InfluxDaoConnectorModelBackup() {
        dao = new InfluxDaoImpl();
        dao.createConnection("192.168.0.24");
       // dao.createDB(dbName);
    ...
    private static class InfluxDaoConnectorHolder {
        ...
        private final static InfluxDaoConnectorModelBackup instance = new InfluxDaoConnectorModelBackup();
    }

    public static InfluxDaoConnectorModelBackup getInstance() {
