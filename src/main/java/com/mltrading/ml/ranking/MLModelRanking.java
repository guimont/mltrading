...
public abstract class MLModelRanking<Model> implements Serializable {
...
*/
    ...
    public MLRank processRanking(List<StockGeneral> l, MLRank mlr) {
        ...
        try {
            ...
            getStatus(mlr).setPerfList(res.collect(), PredictionPeriodicity.D20);
    ...
    protected abstract MLStatus getStatus(MLRank mlr);

    protected abstract Model trainModel(JavaRDD<LabeledPoint> trainingData);

    protected abstract void setModel(MLRank mlr, Model model);
